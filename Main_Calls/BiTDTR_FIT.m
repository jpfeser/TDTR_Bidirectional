...
function [Z,ratio_model]=BiTDTR_FIT(X,ratio_data,tdelay,TCR,tau_rep,f,lambda_down,C_down,h_down,eta_down,lambda_up,C_up,h_up,eta_up,r_pump,r_probe,A_pump)
...
[deltaR_model,ratio_model]=BiTDTR_REFL(tdelay,TCR,tau_rep,f,lambda_down,C_down,h_down,eta_down,lambda_up,C_up,h_up,eta_up,r_pump,r_probe,A_pump);
